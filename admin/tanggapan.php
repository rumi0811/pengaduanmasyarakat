...
<head>
  ...
  <title>Tanggapan Pengaduan - Pemas</title>
        ...
        <span class="text">Kembali</span>
            ...
            <div class="form-group cols-sm-6">
                ...
                <div class="form-group cols-sm-6">
                    ...
                    <textarea name="tanggapan" cols="30" rows="7" class="form-control">
                ...
                <input type="submit" name="" id="" class="btn btn-primary btn-user" value="Tanggapi">
            </form>
        </div>
        </div>
        </div>
